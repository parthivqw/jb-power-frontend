...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = generateContactFormMessage(name.trim(), cleanPhone, bill);
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-jb-gold focus:border-jb-gold outline-none transition-colors"
                  />
                </div>
